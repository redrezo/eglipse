...
package org.eglipse.lang.glsl.services;
...
public class GlslGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class StatementElements extends AbstractParserRuleElementFinder {
		...
		//
		//	WHILE "(" condition=Exp ")" SEMICOLON | {ForStatement} FOR "(" a=(Exp | Declaration) SEMICOLON b=Exp? SEMICOLON
		//
		//	c=Exp? ")" do=Statement | // TODO fix switch statement
		//
	...
	public class SwitchCaseElements extends AbstractParserRuleElementFinder {
		...
		//SwitchCase:
		//
		//	CASE (case=INTCONSTANT | case=UINTCONSTANT | fcase=FLOATCONSTANT) COLON then=Statement | DEFAULT COLON
		//
		//	then=Statement;
		public ParserRule getRule() { return rule; }
	...
	public class AtomicElements extends AbstractParserRuleElementFinder {
		...
		//
		//	{UIntegerLiteral} value=UINTCONSTANT | {FloatLiteral} value=FLOATCONSTANT | {BoolLiteral} value=BOOLCONSTANT | "("
		//
		//	Exp ")";
		public ParserRule getRule() { return rule; }
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.eglipse.lang.glsl.Glsl".equals(grammar.getName())) {
				return grammar;
			}
