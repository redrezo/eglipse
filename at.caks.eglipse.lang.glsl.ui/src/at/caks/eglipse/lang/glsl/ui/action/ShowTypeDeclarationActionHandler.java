package at.caks.eglipse.lang.glsl.ui.action;
...
import at.caks.eglipse.lang.glsl.ui.internal.GlslActivator;
...
public class ShowTypeDeclarationActionHandler extends AbstractHandler {
	...
	public ShowTypeDeclarationActionHandler() {
		GlslActivator.getInstance().getInjector("at.caks.eglipse.lang.glsl.Glsl").injectMembers(this);
	}
	...
	private final class ShowTypeDeclarationAction extends Action {
		...
		private String getDescription(final int offset, final XtextResource resource) {
			if (ts == null) {
				...
				return "Typesystem is null - it was not injected by guice!?";
			}
