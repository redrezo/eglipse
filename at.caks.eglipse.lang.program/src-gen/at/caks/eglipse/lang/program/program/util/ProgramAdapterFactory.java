 ...
 *
 */
package at.caks.eglipse.lang.program.program.util;
...
public class ProgramAdapterFactory extends AdapterFactoryImpl
{
  ...
  /**
   * Creates a new adapter for an object of class '{@link at.caks.eglipse.lang.program.program.Program <em>Program</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link at.caks.eglipse.lang.program.program.Shader <em>Shader</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
